...
class SberlogisticsDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:sberlogistics_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SBERLOGISTICS_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SBERLOGISTICS_DOOR_CLASS_DESCRIPTION");
    }
