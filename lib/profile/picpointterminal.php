...
class PicpointTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'picpoint.png';
    protected static $isProfile = true;
    protected static $service = 'picpoint';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:picpoint_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PICPOINT_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PICPOINT_TERMINAL_CLASS_DESCRIPTION");
    }
