...
class EnergijaDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:energija_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_ENERGIJA_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_ENERGIJA_DOOR_CLASS_DESCRIPTION");
    }
