...
class VozovozDoor extends Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:vozovoz_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_VOZOVOZ_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_VOZOVOZ_DOOR_CLASS_DESCRIPTION");
    }
