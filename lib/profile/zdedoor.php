...
class ZdeDoor extends Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:zde_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_ZDE_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_ZDE_DOOR_CLASS_DESCRIPTION");
    }
