...
class SberlogisticsTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'sberlogistics.png';
    protected static $isProfile = true;
    protected static $service = 'sberlogistics';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:sberlogistics_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SBERLOGISTICS_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SBERLOGISTICS_TERMINAL_CLASS_DESCRIPTION");
    }
