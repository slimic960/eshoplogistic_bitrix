...
class VozovozTerminal extends Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'vozovoz.png';
    protected static $isProfile = true;
    protected static $service = 'vozovoz';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:vozovoz_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_VOZOVOZ_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_VOZOVOZ_TERMINAL_CLASS_DESCRIPTION");
    }
