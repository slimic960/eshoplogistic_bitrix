...
class FivepostTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'fivepost.png';
    protected static $isProfile = true;
    protected static $service = 'fivepost';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:fivepost_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_FIVEPOST_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_FIVEPOST_TERMINAL_CLASS_DESCRIPTION");
    }
