...
class GrastinDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:grastin_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GRASTIN_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GRASTIN_DOOR_CLASS_DESCRIPTION");
    }
