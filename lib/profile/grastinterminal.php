...
class GrastinTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'grastin.png';
    protected static $isProfile = true;
    protected static $service = 'grastin';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:grastin_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GRASTIN_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GRASTIN_TERMINAL_CLASS_DESCRIPTION");
    }
