...
class PostrfTerminal extends Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:postrf_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_POSTRF_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_POSTRF_TERMINAL_CLASS_DESCRIPTION");
    }
